...
class TestTfidfCombinedVectorize(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        archivos_temporales = [
            os.path.join("files", "temporary_tfidf.csv"),
            os.path.join("files", "temporary_ngrams.csv")
        ]
...
class TestAllVectorize(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        temp_word2vec = os.path.join("files", "temporary_word2vec.csv")
        if os.path.exists(temp_word2vec):
            os.remove(temp_word2vec)
...
class TestProcessCSV(unittest.TestCase):
    ...
    def test_target_tfidf(self, mock_tfidf):
        ...
        self.assertEqual(file_name, os.path.join("files", "data_train_tfidf.csv"))
    ...
    def test_target_ngrams(self, mock_ngrams):
        ...
        self.assertEqual(file_name, os.path.join("files", "data_train_ngrams.csv"))
    ...
    def test_target_bigrams(self, mock_ngrams):
        ...
        self.assertEqual(file_name, os.path.join("files", "data_train_bigrams.csv"))
        mock_ngrams.assert_called_once()
    ...
    def test_target_trigrams(self, mock_ngrams):
        ...
        self.assertEqual(file_name, os.path.join("files", "data_train_trigrams.csv"))
        mock_ngrams.assert_called_once()
    ...
    def test_target_all(self, mock_all):
        ...
        self.assertEqual(file_name, os.path.join("files", "data_train_all.csv"))
    ...
    def test_target_tfidf_bigrams(self, mock_tfidf_bigrams):
        ...
        self.assertEqual(file_name, os.path.join("files", "data_train_tfidf_bigrams.csv"))
    ...
    def test_target_tfidf_trigrams(self, mock_tfidf_trigrams):
        ...
        self.assertEqual(file_name, os.path.join("files", "data_train_tfidf_trigrams.csv"))
