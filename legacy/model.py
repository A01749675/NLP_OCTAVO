...
def get_data():
    ...
    # Eliminar columnas no numéricas o que no son features
    columns_to_drop = ["tweet_id", "tweet_text_clean", "class"]

    X = df_tfidf.drop(columns=columns_to_drop, errors="ignore")
    y = df_cleaned["class"]

    # Seguridad extra: conservar solo columnas numéricas
